...
# Player scene paths
var vr_player_path = "res://internal/scenes/players/vr_player.tscn"
var fps_player_path = "res://internal/scenes/players/fps_player.tscn"
...
func _ready():
	...
	if xr_interface and xr_interface.is_initialized():
		...
		print("No VR Headset found! Starting desktop mode.")
